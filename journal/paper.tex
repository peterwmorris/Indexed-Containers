...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{\char95 !!\char95 }\;\in\;\{\mskip1.5mu \Conid{A}\;\in\;\Conid{Set}\mskip1.5mu\}\;\rightarrow\;\{\mskip1.5mu \Varid{n}\;\in\;\Conid{ℕ}\mskip1.5mu\}\;\rightarrow\;\Conid{Vec}\;\Conid{A}\;\Varid{n}\;\rightarrow\;\Conid{Fin}\;\Varid{n}\;\rightarrow\;\Conid{A}{}\<[E]%
\\
\>[B]{}[\mskip1.5mu \mskip1.5mu]\;\mathbin{!!}\;(){}\<[E]%
\\
\>[B]{}(\Varid{a}\;\Varid{∷}\;\Varid{as})\;\mathbin{!!}\;\Varid{zero}\;\mathrel{=}\;\Varid{a}{}\<[E]%
\\
\>[B]{}(\Varid{a}\;\Varid{∷}\;\Varid{as})\;\mathbin{!!}\;\Varid{suc}\;\Varid{n}\;\mathrel{=}\;\Varid{as}\;\mathbin{!!}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
for \ensuremath{\Conid{Fin}}. The mutual definition of \ensuremath{\Conid{NeLam}} and \ensuremath{\Conid{NfLam}} can be
...
\\
\>[B]{}\Conid{FNe}\;\Conid{X}\;\Conid{Y}\;\Varid{n}\;\mathrel{=}\;\Conid{Fin}\;\Varid{n}\;\uplus\;(\Conid{X}\;\Varid{n}\;\times\;\Conid{Y}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
...
We can construct \ensuremath{\Conid{NeLam}} and \ensuremath{\Conid{NfLam}} by an elimination procedure:
first we define a parametrized initial algebra \ensuremath{\Conid{NeLam'}\;\in\;(\Conid{ℕ}\;\rightarrow\;\Conid{Set})\;\rightarrow\;\Conid{ℕ}\;\rightarrow\;\Conid{Set}} so that \ensuremath{\Conid{NeLam'}\;\Conid{Y}} is the initial algebra of \ensuremath{\lambda\;\Conid{X}\;\rightarrow\;\Conid{FNe}\;\Conid{X}\;\Conid{Y}}
and then \ensuremath{\Conid{NfLam}} is the initial algebra of \ensuremath{\lambda\;\Conid{Y}\;\rightarrow\;\Conid{FNf}\;(\Conid{NeLam'}\;\Conid{Y})\;\Conid{Y}}.
Symmetrically we derive \ensuremath{\Conid{NeLam}} --- compare this with the encoding in
section \ref{sec:spf}.
