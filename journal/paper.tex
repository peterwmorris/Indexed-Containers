...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{F}_{\Conid{NeLam}}\;\in\;(\Conid{ℕ}\;\rightarrow\;\Conid{Set})\;\rightarrow\;(\Conid{ℕ}\;\rightarrow\;\Conid{Set})\;\rightarrow\;\Conid{ℕ}\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\Conid{F}_{\Conid{NeLam}}\;\Conid{X}\;\Conid{Y}\;\Varid{n}\;\mathrel{=}\;\Conid{Fin}\;\Varid{n}\;\uplus\;(\Conid{X}\;\Varid{n}\;\uplus\;\Conid{Y}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Conid{F}_{\Conid{NfLam}}\;\in\;(\Conid{ℕ}\;\rightarrow\;\Conid{Set})\;\rightarrow\;(\Conid{ℕ}\;\rightarrow\;\Conid{Set})\;\rightarrow\;\Conid{ℕ}\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\Conid{F}_{\Conid{NfLam}}\;\Conid{X}\;\Conid{Y}\;\Varid{n}\;\mathrel{=}\;(\Conid{Y}\;\ensuremath{\mbox{$\circ$}}\;\Varid{suc})\;\Varid{n}\;\uplus\;\Conid{X}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{sup}\;\in\;(\!\;\Varid{s}\;\in\;\Conid{S}\;\!)\times\;(\Conid{P}\;\Varid{s}\;\rightarrow\;\Conid{W}\;\Conid{S}\;\Conid{P})\;\rightarrow\;\Conid{W}\;\Conid{S}\;\Conid{P}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{wrec}\;\in\;{}\<[9]%
...
syntax, rather than encoding them using \ensuremath{\Varid{wrec}}, all of these definitions can 
be reduced to terms which only use \ensuremath{\Varid{wrec}}.
...
\column{8}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Keyword{record}\;\Conid{Func}\;\in\;\Conid{Set₁}\;\Keyword{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{obj}\;{}\<[8]%
\>[8]{}\in\;\Conid{Set}\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{mor}\;{}\<[8]%
\>[8]{}\in\;\forall{}\;\{\mskip1.5mu \Conid{A}\;\Conid{B}\mskip1.5mu\}\;\rightarrow\;(\Conid{A}\;\rightarrow\;\Conid{B})\;\rightarrow\;\Varid{obj}\;\Conid{A}\;\rightarrow\;\Varid{obj}\;\Conid{B}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
We use ends \ensuremath{\Conid{End}} to capture natural transformations.
...
\>[28]{}\mathrel{=}\;\lambda\;\Conid{A}\;\rightarrow\;(\!\;\Varid{s}\;\in\;\Conid{S}\;\!)\times\;(\Conid{P}\;\Varid{s}\;\rightarrow\;\Conid{A}){}\<[E]%
\\
\>[21]{};\Varid{mor}\;{}\<[28]%
...
\>[15]{}\Varid{obj}\;{}\<[20]%
\>[20]{}\mathrel{=}\;{}\<[23]%
\>[23]{}\lambda\;\Conid{A}\;\rightarrow\;(\!\;\Varid{j}\;\in\;\Conid{J}\;\!)\times\;(\Varid{f}\;\Varid{j}\;\equiv\;\Varid{k}\;\times\;\;\Conid{F}\;\Conid{A}\;\Varid{j}){}\<[E]%
\\
\>[12]{};{}\<[12E]%
\>[15]{}\Varid{mor}\;{}\<[20]%
\>[20]{}\mathrel{=}\;{}\<[23]%
...
\>[14]{}\Varid{obj}\;{}\<[19]%
\>[19]{}\mathrel{=}\;\lambda\;\Conid{A}\;{}\<[26]%
\>[26]{}\rightarrow\;(\!\;\Varid{s}\;\in\;\Conid{S}\;\!)\times\;(\Conid{P}\;\Varid{s}\;\rightarrow^{\star}\;\Conid{A}){}\<[E]%
\\
\>[11]{};{}\<[11E]%
\>[14]{}\Varid{mor}\;{}\<[19]%
...
\begin{align*}
  ...
  \equiv  \;    & \ensuremath{\prodd\;\Conid{X}\;.\;(\!\;\Varid{s}\;\in\;\Conid{S}\;(\Conid{P}\;\Varid{s}\;\rightarrow^{\star}\;\Conid{X})\;\rightarrow\;\Conid{F}\;\Conid{X}} & \{\mbox{by definition}\} \\
...
\begin{align*}
 ...
 \cong \;  & \ensuremath{(\Varid{s}\;\in\;\Conid{S})\;\rightarrow\;(\!\;\Varid{t}\;\in\;\Conid{T}\;^{\star}\;\!)\times\;(\Conid{Q}\;\Varid{t}\;\rightarrow^{\star}\;\Conid{P}\;\Varid{s})} \\
 \cong \;  & \ensuremath{(\!\;\Varid{f}\;\in\;\Conid{S}\;\rightarrow\;\Conid{T}\;\!)\times\;((\Varid{s}\;\in\;\Conid{S})\;\rightarrow\;\Conid{Q}\;(\Varid{f}\;\Varid{s})\;\rightarrow^{\star}\;\Conid{P}\;\Varid{s})}
\end{align*}
...
\>[34]{}((\!\;\Varid{i}\;\in\;\Conid{I}\;\!)\times\;\Conid{P}\;\Varid{s}\;\Varid{i})\;(\lambda (\!\;\Varid{i}\;\!,\!\;\Varid{p}\;\!\!)\;\rightarrow\;\Conid{Q}\;\Varid{i}\;(\Varid{f}\;\Varid{i}\;\Varid{p})\;\Varid{j}\;\!\;\!)\;\!\;\!{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[3]{}\hsindent{5}{}\<[8]%
\>[8]{}((\!\;\Varid{j}\;\in\;\Conid{J}\;\!)\times\;(\Varid{f}\;\Varid{j}\;\equiv\;\Varid{k}\;\times\;\Conid{S}\;\Varid{j}))\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\lhd\;{}\<[8]%
...
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\lhd\;{}\<[8]%
\>[8]{}\lambda\;\Varid{s}\;\Varid{i}\;\rightarrow\;(\!\;\Varid{j}\;\in\;\Conid{J}\;\!)\times\;((\!\;\Varid{eq}\;\in\;\Varid{f}\;\Varid{j}\;\equiv\;\Varid{k}\;\!)\times\;\Conid{P}\;\Varid{j}\;(\Varid{s}\;\Varid{j}\;\Varid{eq})\;\Varid{i}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[8]{}\hsindent{2}{}\<[10]%
\>[10]{}\uplus\;{}\<[13]%
\>[13]{}((\!\;\Varid{j}\;\in\;\Conid{J}\;\!)\times\;((\!\;\Varid{p}\;\in\;\Conid{P}^{\Conid{J}}\;\Varid{s}\;\Varid{j}\;\!)\times\;\Conid{Q}\;\Varid{j}\;(\Varid{f}\;\Varid{j}\;\Varid{p})\;\Varid{i}))\;\!\;\!){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[13]{}\uplus\;{}\<[16]%
\>[16]{}((\!\;\Varid{j′}\;\in\;\Conid{J}\;\!)\times\;((\!\;\Varid{p}\;\in\;\Conid{P}^{\Conid{J}}\;\Varid{j}\;\Varid{s}\;\Varid{j′}\;\!)\times\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{j′}\;(\Varid{f}\;\Varid{j′}\;\Varid{p})\;\Varid{i}))\;{}\<[E]%
\\
...
\\
\>[13]{}\uplus\;{}\<[16]%
\>[16]{}((\!\;\Varid{j′}\;\in\;\Conid{J}\;\!)\times\;((\!\;\Varid{p}\;\in\;\Conid{P}^{\Conid{J}}\;\Varid{j}\;\Varid{s}\;\Varid{j′}\;\!)\times\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{j′}\;(\flat\;(\Varid{f}\;\Varid{j′}\;\Varid{p}))\;\Varid{i}))\;{}\<[E]%
\\
\>[13]{}\rightarrow\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{j}\;(\Varid{sup}\;(\Varid{s},\Varid{f}))\;\Varid{i}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Conid{WI′}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\Conid{S}\;\Conid{P}\;\mathrel{=}\;\Conid{W}\;((\!\;\Varid{i}\;\in\;\Conid{I}\;\!)\times\;\Conid{S}\;\Varid{i})\;(\lambda (\!\;\Varid{i}\;\!,\!\;\Varid{s}\;\!\!)\;\rightarrow\;(\!\;\Varid{i′}\;\in\;\Conid{I}\;\!)\times\;\Conid{P}\;\Varid{i}\;\Varid{s}\;\Varid{i′}\;\!\;\!){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[8]{}(\Conid{P}\;\in\;(\Varid{i}\;\in\;\Conid{I})\;(\Varid{s}\;\in\;\Conid{S}\;\Varid{i})\;\rightarrow\;\Conid{I}\;\rightarrow\;\Conid{Set})\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\Conid{WIl}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\Conid{S}\;\Conid{P}\;\mathrel{=}\;\Conid{W}\;(\Conid{I}\;\times\;((\!\;\Varid{i}\;\in\;\Conid{I}\;\!)\times\;\Conid{S}\;\Varid{i}))\;(\lambda (\!\;\Varid{i′}\;\!,\!\;\Varid{i}\;\!,\!\;\Varid{s}\;\!\!)\;\rightarrow\;(\!\;\Varid{i′}\;\in\;\Conid{I}\;\!)\times\;\Conid{P}\;\Varid{i}\;\Varid{s}\;\Varid{i′}\;\!\;\!){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Keyword{where}\;\Conid{PathS}\;\in\;(\!\;\Varid{j}\;\in\;\Conid{J}\;\!)\times\;\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{J}}\;\Varid{j}\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Conid{PathP}\;\in\;(\Varid{jw}\;\in\;(\!\;\Varid{j}\;\in\;\Conid{J}\;\!)\times\;\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{J}}\;\Varid{j})\;(\Varid{s}\;\in\;\Conid{PathS}\;\Varid{jw})\;\rightarrow\;(\!\;\Varid{j}\;\in\;\Conid{J}\;\!)\times\;\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{J}}\;\Varid{j}\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\\
\>[B]{}\Conid{Chain}\;\mathrel{=}\;(\!\;\Conid{A}\;\in\;(\Conid{ℕ}\;\rightarrow\;\Conid{Set})\;\!)\times\;((\Varid{n}\;\in\;\Conid{ℕ})\;\rightarrow\;\Conid{A}\;(\Varid{suc}\;\Varid{n})\;\rightarrow\;\Conid{A}\;\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Conid{LIM}\;(\Conid{A},\Varid{a})\;\mathrel{=}\;(\!\;\Varid{f}\;\in\;((\Varid{n}\;\in\;\Conid{ℕ})\;\rightarrow\;\Conid{A}\;\Varid{n})\;\!)\times\;((\Varid{n}\;\in\;\Conid{ℕ})\;\rightarrow\;\Varid{a}\;\Varid{n}\;(\Varid{f}\;(\Varid{suc}\;\Varid{n}))\;\equiv\;\Varid{f}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
...
\>[18]{}({}\<[21]%
\>[21]{}({}\<[21E]%
\>[24]{}\lambda\;\Varid{n}\;\rightarrow\;(\!\;\Varid{s}\;\in\;\Conid{S}\;\!)\times\;(\Conid{P}\;\Varid{s}\;\rightarrow\;\Conid{A}\;\Varid{n})){}\<[E]%
\\
\>[18]{},{}\<[24]%
...
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}\rightarrow\;(\!\;\Varid{s}\;\in\;\Conid{S}\;\!)\times\;(\Conid{P}\;\Varid{s}\;\rightarrow\;(\Conid{LIM}\;(\Conid{A},\Varid{a}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{T}_{\Conid{NeLam}}\;\in\;\Conid{SPF}\;\bot\;\Conid{ℕ}{}\<[E]%
\\
\>[B]{}\Conid{T}_{\Conid{NeLam}}\;\mathrel{=}\;\mu^{\text{\tiny T}}\;({}\<[17]%
\>[17]{}\Conid{SPF}\;(\lambda\;())\;\Conid{T}_{\Conid{Fin}}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbin{\uplus^{\text{\tiny T}}}\;{}\<[17]%
\>[17]{}((\eta^{\text{\tiny T}}\;\ensuremath{\mbox{$\circ$}}\;\Varid{inr})\;\mathbin{\times^{\text{\tiny T}}}\;\Conid{T}_{\Conid{NeNf}})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Keyword{where}\;{}\<[10]%
\>[10]{}\Conid{T}_{\Conid{NeNf}}\;\in\;\Conid{SPF}\;(\bot\;\uplus\;\Conid{ℕ})\;\Conid{ℕ}{}\<[E]%
\\
\>[10]{}\Conid{T}_{\Conid{NeNf}}\;\mathrel{=}\;\mu^{\text{\tiny T}}\;{}\<[23]%
\>[23]{}({}\<[29]%
...
\\[\blanklineskip]%
\>[B]{}\Conid{T}_{\Conid{NfLam}}\;\in\;\Conid{SPF}\;\bot\;\Conid{ℕ}{}\<[E]%
\\
\>[B]{}\Conid{T}_{\Conid{NfLam}}\;\mathrel{=}\;\mu^{\text{\tiny T}}\;{}\<[12]%
\>[12]{}({}\<[18]%
\>[18]{}\Delta^{\text{\tiny T}}\;\Varid{suc}\;(\eta^{\text{\tiny T}}\;\ensuremath{\mbox{$\circ$}}\;\Varid{inr}){}\<[E]%
\\
\>[12]{}\mathbin{\uplus^{\text{\tiny T}}}\;{}\<[18]%
\>[18]{}\Conid{T}_{\Conid{NfNe}}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Keyword{where}\;{}\<[10]%
\>[10]{}\Conid{T}_{\Conid{NfNe}}\;\in\;\Conid{SPF}\;(\bot\;\uplus\;\Conid{ℕ})\;\Conid{ℕ}{}\<[E]%
\\
\>[10]{}\Conid{T}_{\Conid{NfNe}}\;\mathrel{=}\;\mu^{\text{\tiny T}}\;{}\<[23]%
\>[23]{}({}\<[29]%
