...
This obviously creates non-canonical elements of \ensuremath{\Varid{\char95 ≅\char95 }}, but does not make our theory unsound.
...
Instead of having all of Agda's data-types we assume that we only have \ensuremath{\Conid{W}}-types. A type theory has \ensuremath{\Conid{W}} types if it has a type former \ensuremath{\Conid{W}\;\in\;(\Conid{S}\;\in\;\Conid{Set})\;(\Conid{P}\;\in\;\Conid{S}\;\rightarrow\;\Conid{Set})\;\rightarrow\;\Conid{Set}} with a constructor \ensuremath{\Varid{sup}} and an eliminator \ensuremath{\Varid{wrec}}:
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{sup}\;\in\;(\Sigma\;\Conid{S}\;\lambda\;\Varid{s}\;\rightarrow\;\Conid{P}\;\Varid{s}\;\rightarrow\;\Conid{W}\;\Conid{S}\;\Conid{P})\;\rightarrow\;\Conid{W}\;\Conid{S}\;\Conid{P}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{wrec}\;\in\;{}\<[9]%
...
\>[28]{}\mathrel{=}\;\lambda\;\Conid{A}\;\rightarrow\;\Sigma\;\Conid{S}\;\lambda\;\Varid{s}\;\rightarrow\;\Conid{P}\;\Varid{s}\;\rightarrow\;\Conid{A}{}\<[E]%
\\
\>[21]{};\Varid{mor}\;{}\<[28]%
...
\\[\blanklineskip]%
\>[B]{}\anonymous \Varid{⊎\char94 F}\anonymous \;\in\;\forall{}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\rightarrow\;(\Conid{F}\;\Conid{G}\;\in\;\Conid{IFunc}\;\Conid{I})\;\rightarrow\;\Conid{IFunc}^{\star}\;\Conid{I}\;\top{}\<[E]%
\\
...
\>[14]{}\Varid{obj}\;{}\<[19]%
\>[19]{}\mathrel{=}\;\lambda\;\Conid{A}\;{}\<[26]%
\>[26]{}\rightarrow\;\Sigma\;\Conid{S}\;(\lambda\;\Varid{s}\;\rightarrow\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{P}\;\Varid{s}\;\Varid{i}\;\rightarrow\;\Conid{A}\;\Varid{i}){}\<[E]%
\\
\>[11]{};{}\<[11E]%
\>[14]{}\Varid{mor}\;{}\<[19]%
...
\>[34]{}(\Sigma\;\Conid{I}\;(\Conid{P}\;\Varid{s}))\;(\lambda (\!\;\Varid{i}\;\!,\!\;\Varid{p}\;\!\!)\;\rightarrow\;\Conid{Q}\;\Varid{i}\;(\Varid{f}\;\Varid{i}\;\Varid{p})\;\Varid{j}\;\!\;\!)\;\!\;\!{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[3]{}\hsindent{5}{}\<[8]%
\>[8]{}(\Sigma\;\Conid{J}\;\lambda\;\Varid{j}\;\rightarrow\;\Varid{f}\;\Varid{j}\;\equiv\;\Varid{k}\;\times\;\Conid{S}\;\Varid{j})\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\lhd\;{}\<[8]%
...
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\lhd\;{}\<[8]%
\>[8]{}\lambda\;\Varid{s}\;\Varid{i}\;\rightarrow\;\Sigma\;\Conid{J}\;\lambda\;\Varid{j}\;\rightarrow\;\Sigma\;(\Varid{f}\;\Varid{j}\;\equiv\;\Varid{k})\;\lambda\;\Varid{eq}\;\rightarrow\;\Conid{P}\;\Varid{j}\;(\Varid{s}\;\Varid{j}\;\Varid{eq})\;\Varid{i}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Keyword{in}\;{}\<[8]%
\>[8]{}\!\;\Varid{⟦}\;\Conid{S}\;\lhd\;\Conid{P}^{\Conid{J}}\;\Varid{⟧}\;\Conid{T}\;\lhd\;{}\<[37]%
\>[37]{}(\lambda (\!\;\Varid{s}\;\!,\!\;\Varid{f}\;\!\!)\;\Varid{i}\;\!\;\rightarrow\;\Conid{P}^{\Conid{I}}\;\Varid{s}\;\Varid{i}{}\<[E]%
\\
\>[8]{}\hsindent{26}{}\<[34]%
\>[34]{}\uplus\;{}\<[37]%
\>[37]{}(\Sigma\;\Conid{J}\;\lambda\;\Varid{j}\;\rightarrow\;\Sigma\;(\Conid{P}^{\Conid{J}}\;\Varid{s}\;\Varid{j})\;\lambda\;\Varid{p}\;\rightarrow\;\Conid{Q}\;\Varid{j}\;(\Varid{f}\;\Varid{j}\;\Varid{p})\;\Varid{i})\;\!\;\!){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[13]{}\uplus\;{}\<[16]%
\>[16]{}(\Sigma\;\Conid{J}\;\lambda\;\Varid{j′}\;\rightarrow\;\Sigma\;(\Conid{P}^{\Conid{J}}\;\Varid{j}\;\Varid{s}\;\Varid{j′})\;\lambda\;\Varid{p}\;\rightarrow\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{j′}\;(\Varid{f}\;\Varid{j′}\;\Varid{p})\;\Varid{i})\;{}\<[E]%
\\
...
\\
\>[B]{}\Varid{in}^{\text{\tiny C}}\;\Conid{F}\;\mathrel{=}\;(\lambda\;\anonymous \;\rightarrow\;\Varid{sup})\;\lhd^{\star}\;\lambda\;\anonymous \;\anonymous \;\Varid{p}\;\rightarrow\;\Varid{path}\Varid{⁻¹}\;\Varid{p}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[21]{}\{\mskip1.5mu \Varid{j}\;\in\;\Conid{J}\mskip1.5mu\}\;(\Varid{s}\;\in\;\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{J}}\;\Varid{j})\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{Q}\;\Varid{j}\;(\Varid{ffold}\;\Varid{j}\;\Varid{s})\;\Varid{i}\;\rightarrow\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{j}\;\Varid{s}\;\Varid{i}{}\<[E]%
\\
...
\>[60]{}\mathrel{=}\;\Varid{path}\;(\Varid{inl}\;\Varid{x}){}\<[E]%
\\
\>[12]{}\Varid{rfold}\;(\Varid{sup}\;(\Varid{s},\Varid{f}))\;\Varid{i}\;\Varid{p}\;{}\<[37]%
\>[37]{}\mid \;\Varid{inr}\;(\Varid{j′},(\Varid{q},\Varid{y}))\;{}\<[60]%
\>[60]{}\mathrel{=}\;\Varid{path}\;(\Varid{inr}\;(\Varid{j′},(\Varid{q},\Varid{rfold}\;(\Varid{f}\;\Varid{j′}\;\Varid{q})\;\Varid{i}\;\Varid{y}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Keyword{data}\;\Conid{Path}\;{}\<[12]%
\>[12]{}\{\mskip1.5mu \Conid{I}\;\Conid{J}\;\in\;\Conid{Set}\mskip1.5mu\}\;(\Conid{S}\;\in\;\Conid{I}\;\rightarrow\;\Conid{Set})\;{}\<[E]%
\\
\>[12]{}(\Conid{P}^{\Conid{I}}\;{}\<[17]%
\>[17]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{S}\;\Varid{i}\;\rightarrow\;\Conid{I}\;{}\<[38]%
\>[38]{}\rightarrow\;\Conid{Set})\;{}\<[E]%
\\
\>[12]{}(\Conid{P}^{\Conid{J}}\;{}\<[17]%
\>[17]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{S}\;\Varid{i}\;\rightarrow\;\Conid{J}\;{}\<[38]%
\>[38]{}\rightarrow\;\Conid{Set})\;{}\<[E]%
\\
\>[12]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{MI}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Varid{i}\;\rightarrow\;\Conid{J}\;\rightarrow\;\Conid{Set}\;\Keyword{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{path}\;\in\;\forall{}\;{}\<[13]%
\>[13]{}\{\mskip1.5mu \Varid{i}\;\Varid{s}\;\Varid{f}\;\Varid{j}\mskip1.5mu\}\;\rightarrow\;{}\<[E]%
\\
\>[13]{}\hsindent{3}{}\<[16]%
\>[16]{}\Conid{P}^{\Conid{J}}\;\Varid{i}\;\Varid{s}\;\Varid{j}\;{}\<[E]%
\\
\>[13]{}\uplus\;{}\<[16]%
\>[16]{}(\Sigma\;\Conid{I}\;\lambda\;\Varid{i′}\;\rightarrow\;\Sigma\;(\Conid{P}^{\Conid{I}}\;\Varid{i}\;\Varid{s}\;\Varid{i′})\;\lambda\;\Varid{p}\;\rightarrow\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{i′}\;(\flat\;(\Varid{f}\;\Varid{i′}\;\Varid{p}))\;\Varid{j})\;{}\<[E]%
\\
\>[13]{}\rightarrow\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{i}\;(\Varid{sup}\;(\Varid{s},\Varid{f}))\;\Varid{j}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\nu^{\text{\tiny C}}\;\in\;\{\mskip1.5mu \Conid{I}\;\Conid{J}\;\in\;\Conid{Set}\mskip1.5mu\}\;\rightarrow\;\Conid{ICont}^{\star}\;(\Conid{I}\;\uplus\;\Conid{J})\;\Conid{I}\;\rightarrow\;\Conid{ICont}^{\star}\;\Conid{J}\;\Conid{I}{}\<[E]%
\\
...
\>[3]{}\Keyword{let}\;{}\<[8]%
\>[8]{}\Conid{P}^{\Conid{I}}\;{}\<[12]%
\>[12]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{S}\;\Varid{i}\;\rightarrow\;\Conid{I}\;{}\<[33]%
\>[33]{}\rightarrow\;\Conid{Set};{}\<[42]%
\>[42]{}\Conid{P}^{\Conid{I}}\;{}\<[46]%
\>[46]{}\Varid{i}\;\Varid{s}\;\Varid{i′}\;{}\<[54]%
\>[54]{}\mathrel{=}\;\Conid{P}\;\!\!\;\Varid{i}\;\!\!\;\Varid{s}\;\!\!\;(\Varid{inl}\;\Varid{i′}){}\<[E]%
\\
\>[8]{}\Conid{P}^{\Conid{J}}\;{}\<[12]%
\>[12]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{S}\;\Varid{i}\;\rightarrow\;\Conid{J}\;{}\<[33]%
\>[33]{}\rightarrow\;\Conid{Set};{}\<[42]%
\>[42]{}\Conid{P}^{\Conid{J}}\;{}\<[46]%
\>[46]{}\Varid{i}\;\Varid{s}\;\Varid{j}\;{}\<[54]%
\>[54]{}\mathrel{=}\;\Conid{P}\;\!\!\;\Varid{i}\;\!\!\;\Varid{s}\;\!\!\;(\Varid{inr}\;\Varid{j}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Keyword{in}\;{}\<[8]%
\>[8]{}\Conid{MI}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\lhd^{\star}\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{out}^{\text{\tiny C}}\;\in\;\forall{}\;\{\mskip1.5mu \Conid{I}\;\Conid{J}\mskip1.5mu\}\;\rightarrow\;(\Conid{F}\;\in\;\Conid{ICont}^{\star}\;(\Conid{I}\;\uplus\;\Conid{J})\;\Conid{I})\;\rightarrow\;\nu^{\text{\tiny C}}\;\Conid{F}\;\Rightarrow^{\text{\tiny C}^{\star}}\;\Conid{F}\;[\mskip1.5mu \;\nu^{\text{\tiny C}}\;\Conid{F}\;\mskip1.5mu]^{\text{\tiny{C}}^{\star}}{}\<[E]%
\\
\>[B]{}\Varid{out}^{\text{\tiny C}}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{J}\mskip1.5mu\}\;(\Conid{S}\;\lhd^{\star}\;\Conid{P})\;\mathrel{=}\;(\lambda\;\anonymous \;\rightarrow\;\Varid{sup⁻¹})\;\lhd^{\star}\;\Varid{unsup}\;\{\mskip1.5mu \anonymous \mskip1.5mu\}\;\{\mskip1.5mu \anonymous \mskip1.5mu\}\;\{\mskip1.5mu \anonymous \mskip1.5mu\}\;\{\mskip1.5mu \lambda\;\Varid{j}\;\Varid{s}\;\rightarrow\;(\Varid{i}\;\in\;\Conid{J})\;\rightarrow\;\Conid{P}\;\Varid{j}\;(\pi_{0}\;(\Varid{sup⁻¹}\;\Varid{s}))\;(\Varid{inr}\;\Varid{i})\;\uplus{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Sigma\;\Conid{I}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}(\lambda\;\Varid{i'}\;\rightarrow\;{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Sigma\;(\Conid{P}\;\Varid{j}\;(\pi_{0}\;(\Varid{sup⁻¹}\;\Varid{s}))\;(\Varid{inl}\;\Varid{i'}))\;{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}(\lambda\;\Varid{p}\;\rightarrow\;{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}\Conid{Path}\;\Conid{S}\;(\lambda\;\Varid{i0}\;\Varid{s'}\;\Varid{i′}\;\rightarrow\;\Conid{P}\;\Varid{i0}\;\Varid{s'}\;(\Varid{inl}\;\Varid{i′}))\;{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(\lambda\;\Varid{i0}\;\Varid{s'}\;\Varid{j'}\;\rightarrow\;\Conid{P}\;\Varid{i0}\;\Varid{s'}\;(\Varid{inr}\;\Varid{j'}))\;\Varid{i'}\;(\pi_{1}\;(\Varid{sup⁻¹}\;\Varid{s})\;\Varid{i'}\;\Varid{p})\;\Varid{i}))\;\rightarrow{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Conid{Path}\;\Conid{S}\;(\lambda\;\Varid{i'}\;\Varid{s'}\;\Varid{i′}\;\rightarrow\;\Conid{P}\;\Varid{i'}\;\Varid{s'}\;(\Varid{inl}\;\Varid{i′})){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}(\lambda\;\Varid{i'}\;\Varid{s'}\;\Varid{j'}\;\rightarrow\;\Conid{P}\;\Varid{i'}\;\Varid{s'}\;(\Varid{inr}\;\Varid{j'}))\;\Varid{j}\;\Varid{s}\;\Varid{i}\mskip1.5mu\}\;(\lambda\;\Varid{sf}\;\Varid{i′}\;\Varid{p}\;\rightarrow\;\Varid{path}\;\Varid{p}){}\<[E]%
\\[\blanklineskip]%
...
\>[23]{}\{\mskip1.5mu \Varid{i}\;\in\;\Conid{I}\mskip1.5mu\}\;(\Varid{t}\;\in\;\Conid{T}\;\Varid{i})\;(\Varid{j}\;\in\;\Conid{J})\;\rightarrow\;\Conid{Path}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{i}\;(\Varid{funfold}\;\Varid{i}\;\Varid{t})\;\Varid{j}\;\rightarrow\;\Conid{Q}\;\Varid{i}\;\Varid{t}\;\Varid{j}{}\<[E]%
\\
\>[12]{}\Varid{runfold}\;\Varid{t}\;\Varid{j}\;(\Varid{path}\;(\Varid{inl}\;\Varid{x}))\;\mathrel{=}\;\Varid{r}\;\Varid{t}\;\Varid{j}\;(\Varid{inl}\;\Varid{x}){}\<[E]%
\\
\>[12]{}\Varid{runfold}\;\Varid{t}\;\Varid{j}\;(\Varid{path}\;(\Varid{inr}\;(\Varid{i},(\Varid{p},\Varid{q}))))\;\mathrel{=}\;\Varid{r}\;\Varid{t}\;\Varid{j}\;(\Varid{inr}\;(\Varid{i},\Varid{p},\Varid{runfold}\;(\pi_{1}\;(\Varid{f}\;\anonymous \;\Varid{t})\;\Varid{i}\;\Varid{p})\;\Varid{j}\;\Varid{q})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\subsubsection{\ensuremath{\Conid{WI}} from \ensuremath{\Conid{W}}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{WI′}\;\in\;\{\mskip1.5mu \Conid{I}\;\in\;\Conid{Set}\mskip1.5mu\}\;(\Conid{S}\;\in\;\Conid{I}\;\rightarrow\;\Conid{Set})\;(\Conid{P}\;\in\;(\Varid{i}\;\in\;\Conid{I})\;(\Varid{s}\;\in\;\Conid{S}\;\Varid{i})\;\rightarrow\;\Conid{I}\;\rightarrow\;\Conid{Set})\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\Conid{WI′}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\Conid{S}\;\Conid{P}\;\mathrel{=}\;\Conid{W}\;(\Sigma\;\Conid{I}\;\Conid{S})\;(\lambda (\!\;\Varid{i}\;\!,\!\;\Varid{s}\;\!\!)\;\rightarrow\;\Sigma\;\Conid{I}\;(\Conid{P}\;\Varid{i}\;\Varid{s})\;\!\;\!){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{WIl}\;\in\;\{\mskip1.5mu \Conid{I}\;\in\;\Conid{Set}\mskip1.5mu\}\;(\Conid{S}\;\in\;\Conid{I}\;\rightarrow\;\Conid{Set})\;(\Conid{P}\;\in\;(\Varid{i}\;\in\;\Conid{I})\;(\Varid{s}\;\in\;\Conid{S}\;\Varid{i})\;\rightarrow\;\Conid{I}\;\rightarrow\;\Conid{Set})\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\Conid{WIl}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\Conid{S}\;\Conid{P}\;\mathrel{=}\;\Conid{W}\;(\Conid{I}\;\times\;(\Sigma\;\Conid{I}\;\Conid{S}))\;(\lambda (\!\;\Varid{i′}\;\!,\!\;\Varid{i}\;\!,\!\;\Varid{s}\;\!\!)\;\rightarrow\;\Sigma\;\Conid{I}\;(\Conid{P}\;\Varid{i}\;\Varid{s})\;\!\;\!){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{WI}\;\in\;\{\mskip1.5mu \Conid{I}\;\in\;\Conid{Set}\mskip1.5mu\}\;(\Conid{S}\;\in\;\Conid{I}\;\rightarrow\;\Conid{Set})\;(\Conid{P}\;\in\;(\Varid{i}\;\in\;\Conid{I})\;(\Varid{s}\;\in\;\Conid{S}\;\Varid{i})\;\rightarrow\;\Conid{I}\;\rightarrow\;\Conid{Set})\;\rightarrow\;\Conid{I}\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
...
\column{37}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Keyword{open}\;\Keyword{import}\;\Varid{ifunc}{}\<[E]%
\\
\>[3]{}\Keyword{open}\;\Keyword{import}\;\Varid{icont}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[19]{},{}\<[19E]%
\>[22]{}\Varid{cong}\;(\Varid{sup}\;(\anonymous ,\anonymous ,\Varid{s}))\;(\Varid{ext}\;\lambda (\!\;\Varid{i}\;\!,\!\;\Varid{p}\;\!\!)\;\rightarrow\;\pi_{1}\;(\Varid{f}\;\Varid{i}\;\Varid{p})\;\!\;\!){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
It's then straight forward but labourious to prove the $\beta$ law for \ensuremath{\Varid{wirec}}, which would have this type:
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{Path}\;\in\;{}\<[9]%
\>[9]{}\{\mskip1.5mu \Conid{I}\;\Conid{J}\;\in\;\Conid{Set}\mskip1.5mu\}\;(\Conid{S}\;\in\;\Conid{I}\;\rightarrow\;\Conid{Set})\;{}\<[E]%
\\
\>[9]{}(\Conid{P}^{\Conid{I}}\;{}\<[14]%
\>[14]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{S}\;\Varid{i}\;\rightarrow\;\Conid{I}\;{}\<[35]%
\>[35]{}\rightarrow\;\Conid{Set})\;{}\<[E]%
\\
\>[9]{}(\Conid{P}^{\Conid{J}}\;{}\<[14]%
\>[14]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{S}\;\Varid{i}\;\rightarrow\;\Conid{J}\;{}\<[35]%
\>[35]{}\rightarrow\;\Conid{Set})\;{}\<[E]%
\\
\>[9]{}(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Varid{i}\;\rightarrow\;\Conid{J}\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[B]{}\Conid{Pathk}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{J}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{S}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{P}^{\Conid{I}}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{P}^{\Conid{J}}\mskip1.5mu\}\;\Varid{i}\;\Varid{w}\;\mathrel{=}\;\Conid{WI}\;\Conid{PathS}\;\Conid{PathP}\;(\Varid{i},\Varid{w}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Keyword{where}\;\Conid{PathS}\;\in\;\Sigma\;\Conid{I}\;(\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{I}})\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Conid{PathS}\;(\Varid{i},\Varid{sup}\;(\Varid{s},\Varid{f}))\;\mathrel{=}\;\Conid{P}^{\Conid{J}}\;\Varid{i}\;\Varid{s}\;\Varid{j}\;\uplus\;\Sigma\;\Conid{I}\;(\Conid{P}^{\Conid{I}}\;\Varid{i}\;\Varid{s}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Conid{PathP}\;\in\;(\Varid{iw}\;\in\;\Sigma\;\Conid{I}\;(\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{I}}))\;(\Varid{s}\;\in\;\Conid{PathS}\;\Varid{iw})\;\rightarrow\;\Sigma\;\Conid{I}\;(\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{I}})\;\rightarrow\;\Conid{Set}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Conid{PathP}\;(\Varid{i},\Varid{sup}\;(\Varid{s},\Varid{f}))\;(\Varid{inl}\;\Varid{p})\;(\Varid{i′},\Varid{w′})\;\mathrel{=}\;\bot{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Conid{PathP}\;(\Varid{i},\Varid{sup}\;(\Varid{s},\Varid{f}))\;(\Varid{inr}\;(\Varid{i′′},\Varid{p}))\;(\Varid{i′},\Varid{w′})\;\mathrel{=}\;{}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}(\Varid{i′′}\;\equiv\;\Varid{i′})\;\times\;(\Varid{f}\;\Varid{i′′}\;\Varid{p}\;\cong\;\Varid{w′}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{path}\;\in\;{}\<[9]%
\>[9]{}\{\mskip1.5mu \Conid{I}\;\Conid{J}\;\in\;\Conid{Set}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{S}\;\in\;\Conid{I}\;\rightarrow\;\Conid{Set}\mskip1.5mu\}\;{}\<[E]%
\\
\>[9]{}\{\mskip1.5mu \Conid{P}^{\Conid{I}}\;{}\<[14]%
\>[14]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{S}\;\Varid{i}\;\rightarrow\;\Conid{I}\;{}\<[35]%
\>[35]{}\rightarrow\;\Conid{Set}\mskip1.5mu\}\;{}\<[E]%
\\
\>[9]{}\{\mskip1.5mu \Conid{P}^{\Conid{J}}\;{}\<[14]%
\>[14]{}\in\;(\Varid{i}\;\in\;\Conid{I})\;\rightarrow\;\Conid{S}\;\Varid{i}\;\rightarrow\;\Conid{J}\;{}\<[35]%
\>[35]{}\rightarrow\;\Conid{Set}\mskip1.5mu\}\;{}\<[E]%
\\
\>[9]{}\{\mskip1.5mu \Varid{i}\;\in\;\Conid{I}\mskip1.5mu\}\;\rightarrow\;\{\mskip1.5mu \Varid{s}\;\in\;\Conid{S}\;\Varid{i}\mskip1.5mu\}\;\{\mskip1.5mu \Varid{f}\;\in\;\Conid{P}^{\Conid{I}}\;\Varid{i}\;\Varid{s}\;\rightarrow^{\star}\;\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\mskip1.5mu\}\;\rightarrow\;\{\mskip1.5mu \Varid{j}\;\in\;\Conid{J}\mskip1.5mu\}\;{}\<[E]%
\\
\>[9]{}\rightarrow\;{}\<[12]%
\>[12]{}\Conid{P}^{\Conid{J}}\;\Varid{i}\;\Varid{s}\;\Varid{j}\;{}\<[22]%
\>[22]{}\uplus\;{}\<[25]%
\>[25]{}(\Sigma\;\Conid{I}\;\lambda\;\Varid{i′}\;\rightarrow\;\Sigma\;(\Conid{P}^{\Conid{I}}\;\Varid{i}\;\Varid{s}\;\Varid{i′})\;\lambda\;\Varid{p}\;\rightarrow\;\Conid{Pathk}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{i′}\;(\Varid{f}\;\Varid{i′}\;\Varid{p})\;\Varid{j})\;{}\<[E]%
\\
\>[9]{}\rightarrow\;{}\<[12]%
\>[12]{}\Conid{Pathk}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;\Varid{i}\;(\Varid{sup}\;(\Varid{s},\Varid{f}))\;\Varid{j}{}\<[E]%
\\
\>[B]{}\Varid{pathk}\;(\Varid{inl}\;\Varid{p})\;\mathrel{=}\;\Varid{sup}\;(\Varid{inl}\;\Varid{p},\lambda\;\Varid{i}\;()){}\<[E]%
\\
\>[B]{}\Varid{pathk}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{J}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{S}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{P}^{\Conid{I}}\mskip1.5mu\}\;\{\mskip1.5mu \Conid{P}^{\Conid{J}}\mskip1.5mu\}\;\{\mskip1.5mu \Varid{i}\mskip1.5mu\}\;\{\mskip1.5mu \Varid{s}\mskip1.5mu\}\;\{\mskip1.5mu \Varid{f}\mskip1.5mu\}\;\{\mskip1.5mu \Varid{j}\mskip1.5mu\}\;(\Varid{inr}\;(\Varid{i′′},(\Varid{q},\Varid{r})))\;\mathrel{=}\;\Varid{sup}\;((\Varid{inr}\;(\Varid{i′′},\Varid{q})),\Varid{sub}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Keyword{where}\;\Varid{sub}\;\in\;(\Varid{iw}\;\in\;\Sigma\;\Conid{I}\;(\Conid{WI}\;\Conid{S}\;\Conid{P}^{\Conid{I}}))\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{15}{}\<[18]%
\>[18]{}(\Varid{i′′}\;\equiv\;\pi_{0}\;\Varid{iw})\;\times\;(\Varid{f}\;\Varid{i′′}\;\Varid{q}\;\cong\;\pi_{1}\;\Varid{iw})\;\rightarrow\;\Conid{Pathk}\;\Conid{S}\;\Conid{P}^{\Conid{I}}\;\Conid{P}^{\Conid{J}}\;(\pi_{0}\;\Varid{iw})\;(\pi_{1}\;\Varid{iw})\;\Varid{j}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{sub}\;(\Varid{i′},\Varid{w′})\;(\Varid{eqi},\Varid{eqw})\;\mathrel{=}\;\Varid{subst}\;(\Conid{WI}\;\anonymous \;\anonymous )\;(\Varid{cong₂}\;\anonymous ,\anonymous \;\Varid{eqi}\;\Varid{eqw})\;\Varid{r}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
to \ensuremath{\Conid{W}} types. This is a result from \cite{C-CSPTs}, though in the setting of 
...
\\
\>[B]{}\Conid{Chain}\;\mathrel{=}\;\Sigma\;(\Conid{ℕ}\;\rightarrow\;\Conid{Set})\;\lambda\;\Conid{A}\;\rightarrow\;(\Varid{n}\;\in\;\Conid{ℕ})\;\rightarrow\;\Conid{A}\;(\Varid{suc}\;\Varid{n})\;\rightarrow\;\Conid{A}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Conid{LIM}\;(\Conid{A},\Varid{a})\;\mathrel{=}\;\Sigma\;((\Varid{n}\;\in\;\Conid{ℕ})\;\rightarrow\;\Conid{A}\;\Varid{n})\;\lambda\;\Varid{f}\;\rightarrow\;((\Varid{n}\;\in\;\Conid{ℕ})\;\rightarrow\;\Varid{a}\;\Varid{n}\;(\Varid{f}\;(\Varid{suc}\;\Varid{n}))\;\equiv\;\Varid{f}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{tailC}\;\in\;(\Varid{c}\;\in\;\Conid{Chain})\;\rightarrow\;\Conid{LIM}\;\Varid{c}\;\rightarrow\;\Conid{LIM}\;(\pi_{0}\;\Varid{c}\;\ensuremath{\mbox{$\circ$}}\;\Varid{suc},\pi_{1}\;\Varid{c}\;\ensuremath{\mbox{$\circ$}}\;\Varid{suc}){}\<[E]%
\\
\>[B]{}\Varid{tailC}\;(\Conid{A},\Varid{a})\;(\Varid{f},\Varid{p})\;\mathrel{=}\;\Varid{f}\;\ensuremath{\mbox{$\circ$}}\;\Varid{suc},\Varid{p}\;\ensuremath{\mbox{$\circ$}}\;\Varid{suc}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tailC⁻¹}\;\in\;(\Varid{c}\;\in\;\Conid{Chain})\;\rightarrow\;\Conid{LIM}\;(\pi_{0}\;\Varid{c}\;\ensuremath{\mbox{$\circ$}}\;\Varid{suc},\pi_{1}\;\Varid{c}\;\ensuremath{\mbox{$\circ$}}\;\Varid{suc})\;\rightarrow\;\Conid{LIM}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{tailC⁻¹}\;(\Conid{A},\Varid{a})\;(\Varid{f},\Varid{p})\;\mathrel{=}\;\Varid{f′},\Varid{p′}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\noindent 
this allows us to construct the isomorphism between \ensuremath{\Conid{F}\;(\Conid{LIM}\;\Conid{F}\;\!^{\omega})} and 
...
\>[18]{}({}\<[21]%
\>[21]{}({}\<[21E]%
\>[24]{}\lambda\;\Varid{n}\;\rightarrow\;\Sigma\;\Conid{S}\;\lambda\;\Varid{s}\;\rightarrow\;\Conid{P}\;\Varid{s}\;\rightarrow\;\Conid{A}\;\Varid{n}){}\<[E]%
\\
\>[18]{},{}\<[24]%
...
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}\rightarrow\;(\Sigma\;\Conid{S}\;\lambda\;\Varid{s}\;\rightarrow\;\Conid{P}\;\Varid{s}\;\rightarrow\;(\Conid{LIM}\;(\Conid{A},\Varid{a}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[47]{}\rightarrow\;\Conid{SPF}\;\Conid{I}\;\Conid{J}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\anonymous \bind ^{\text{\tiny T}}\anonymous \;\in\;\forall{}\;\{\mskip1.5mu \Conid{I}\;\Conid{J}\mskip1.5mu\}\;\rightarrow\;\Conid{ISPT}\;\Conid{I}\;\rightarrow\;\Conid{SPF}\;\Conid{J}\;\Conid{I}\;\rightarrow\;\Conid{ISPT}\;\Conid{J}{}\<[E]%
\\
\>[B]{}\eta^{\text{\tiny T}}\;\Varid{i}\;{}\<[12]%
\>[12]{}\bind ^{\text{\tiny T}}\;\Conid{F}\;\mathrel{=}\;\Conid{F}\;\Varid{i}{}\<[E]%
\\
\>[B]{}\Delta^{\text{\tiny T}}\;\Varid{f}\;\Conid{G}\;\Varid{j}\;{}\<[12]%
\>[12]{}\bind ^{\text{\tiny T}}\;\Conid{F}\;\mathrel{=}\;\Delta^{\text{\tiny T}}\;\Varid{f}\;(\lambda\;\Varid{k}\;\rightarrow\;\Conid{G}\;\Varid{k}\;\bind ^{\text{\tiny T}}\;\Conid{F})\;\Varid{j}{}\<[E]%
\\
\>[B]{}\Sigma^{\text{\tiny T}}\;\Varid{f}\;\Conid{G}\;\Varid{k}\;{}\<[12]%
\>[12]{}\bind ^{\text{\tiny T}}\;\Conid{F}\;\mathrel{=}\;\Sigma^{\text{\tiny T}}\;\Varid{f}\;(\lambda\;\Varid{j}\;\rightarrow\;\Conid{G}\;\Varid{j}\;\bind ^{\text{\tiny T}}\;\Conid{F})\;\Varid{k}{}\<[E]%
\\
\>[B]{}\Pi^{\text{\tiny T}}\;\Varid{f}\;\Conid{G}\;\Varid{k}\;{}\<[12]%
\>[12]{}\bind ^{\text{\tiny T}}\;\Conid{F}\;\mathrel{=}\;\Pi^{\text{\tiny T}}\;\Varid{f}\;(\lambda\;\Varid{j}\;\rightarrow\;\Conid{G}\;\Varid{j}\;\bind ^{\text{\tiny T}}\;\Conid{F})\;\Varid{k}{}\<[E]%
\\
\>[B]{}\mu^{\text{\tiny T}}\;\Conid{G}\;\Varid{j}\;{}\<[12]%
\>[12]{}\bind ^{\text{\tiny T}}\;\Conid{F}\;\mathrel{=}\;\mu^{\text{\tiny T}}\;(\lambda\;\Varid{k}\;\rightarrow\;\Conid{G}\;\Varid{k}\;\bind ^{\text{\tiny T}}\;[\mskip1.5mu {}\<[46]%
\>[46]{}(\lambda\;\Varid{i}\;\rightarrow\;\Conid{F}\;\Varid{i}\;\bind ^{\text{\tiny T}}\;(\eta^{\text{\tiny T}}\;\ensuremath{\mbox{$\circ$}}\;\Varid{inl})),(\eta^{\text{\tiny T}}\;\ensuremath{\mbox{$\circ$}}\;\Varid{inr})\mskip1.5mu])\;\Varid{j}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
The 1st is by definition, and the others follow by induction of \ensuremath{\Conid{F}}. 
To show that the structure is preserved by \ensuremath{\Varid{⟦}\anonymous \Varid{⟧}^{\text{\tiny T}}} it is sufficient to suw that for are \ensuremath{\Conid{F}\;\in\;\Conid{ISPT}\;\Conid{J}} and \ensuremath{\Conid{G}\;\in\;\Conid{SPF}\;\Conid{I}\;\Conid{J}} there exist mutually inverse container 
morphisms:
...
\\[\blanklineskip]%
\>[B]{}\anonymous \Varid{⊎\char94 T}\anonymous \;\in\;\forall{}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\rightarrow\;(\Conid{F}\;\Conid{G}\;\in\;\Conid{ISPT}\;\Conid{I})\;\rightarrow\;\Conid{ISPT}\;\Conid{I}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\anonymous \mathbin{\times^{\text{\tiny T}}}\anonymous \;\in\;\forall{}\;\{\mskip1.5mu \Conid{I}\mskip1.5mu\}\;\rightarrow\;(\Conid{F}\;\Conid{G}\;\in\;\Conid{ISPT}\;\Conid{I})\;\rightarrow\;\Conid{ISPT}\;\Conid{I}{}\<[E]%
\\
...
\column{21}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{T}_{Fin}\;\in\;\Conid{SPF}\;\bot\;\Conid{ℕ}{}\<[E]%
\\
\>[B]{}\Conid{T}_{Fin}\;\mathrel{=}\;\mu^{\text{\tiny T}}\;(\Sigma^{\text{\tiny T}}\;\Varid{suc}\;(\Varid{⊤\char94 T*}\;\Varid{+\char94 T*}\;(\eta^{\text{\tiny T}}\;\ensuremath{\mbox{$\circ$}}\;\Varid{inr}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Conid{T}_{Fin}\;\in\;\Conid{SPF}\;\top\;\Conid{ℕ}{}\<[E]%
\\
\>[B]{}\Conid{T}_{Fin}\;\mathrel{=}\;{}\<[9]%
\>[9]{}\mu^{\text{\tiny T}}\;{}\<[15]%
\>[15]{}({}\<[21]%
...
\\[\blanklineskip]%
\>[B]{}\Conid{T}_{ScLam}\;\in\;\Conid{SPF}\;\bot\;\Conid{ℕ}{}\<[E]%
\\
\>[B]{}\Conid{T}_{ScLam}\;\mathrel{=}\;\mu^{\text{\tiny T}}\;{}\<[15]%
\>[15]{}({}\<[21]%
\>[21]{}(\eta^{\text{\tiny T}}\;\ensuremath{\mbox{$\circ$}}\;\Varid{inr}){}\<[E]%
\\
\>[15]{}\Varid{+\char94 T*}\;{}\<[21]%
\>[21]{}(((\eta^{\text{\tiny T}}\;\ensuremath{\mbox{$\circ$}}\;\Varid{inr})\;\Varid{×\char94 T*}\;(\eta^{\text{\tiny T}}\;\ensuremath{\mbox{$\circ$}}\;\Varid{inr})){}\<[E]%
\\
\>[15]{}\Varid{+\char94 T*}\;{}\<[21]%
